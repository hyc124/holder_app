  ...
  jsMind.draggable.prototype = {
    ...
    _event_bind: function () {
      ...
      jdom.add_event(container, 'mousedown', function (e) {
        var evt = e || event
        // 0-左键，2-鼠标右键，禁用右键点击拖动
        if (evt.button == 2 && thisJm.options.disableContextDrag) {
          return
        }
      ...
      jQuery('.dragItem')
        ...
        .on('mousedown', function (e) {
          if (e.button == 2 && thisJm.options.disableContextDrag) {
            return
          }
          // 右侧新增按住鼠标事件
          var evt = e || event
    ...
    drag: function (e) {
      ...
      if (this.capture) {
        ...
        clear_selection()
        jQuery('.WorkPlanMindRightMeun').addClass('hide_animate')
      }
    },
